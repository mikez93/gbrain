...
-- ============================================================
-- Reversible page-disposition ledger and current projection (v142)
-- ============================================================
...
BEGIN
  ...
  IF has_bypass THEN
    ...
    ALTER TABLE page_disposition_operations ENABLE ROW LEVEL SECURITY;
    ALTER TABLE page_disposition_events ENABLE ROW LEVEL SECURITY;
    ALTER TABLE page_dispositions ENABLE ROW LEVEL SECURITY;
    ALTER TABLE page_disposition_state ENABLE ROW LEVEL SECURITY;
