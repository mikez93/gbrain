...
const OP_AREAS: Record<string, string> = {
  ...
  // takes + think
  takes_list: 'takes', takes_search: 'takes', takes_propose_list: 'takes', takes_propose_accept: 'takes',
  takes_propose_reject: 'takes', think: 'takes', takes_scorecard: 'takes', takes_calibration: 'takes',
  // hot memory (facts)
